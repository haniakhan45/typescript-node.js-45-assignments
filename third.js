...
let current_users = ["admin", "fariha", "fatima", "madiha", "areeba"];
let new_users = ["admin", "areeba", "kainat", "roha", "laiba"];
...
// I really love pizza!
let pizzas = ["pepperoni", "hawaiian", "bbq chicken"];
...
let magician = ["abdullah", "hamza", "hasan"];
...
let magicians2 = ["usama", "mohsin", "wahaj"];
...
let magicians3 = ["usama", "mohsin", "wahaj"];
...
let mycar = createCar("toyota", "corolla", { color: "white", year: "2024" });
console.log(mycar);
